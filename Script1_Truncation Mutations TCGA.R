################################################################################################################
# Script 1: Identifying truncation mutations within the TCGA database that occur before the end of the kinase  #
# domain.                                                                                                      #
#                                                                                                              #
# Automatic search function to detect TCGA trucation mutations occuring before the end of kinase domains.      #
################################################################################################################
...
# Load and merge the definitive gene names with GENBANK.
...
# NOTE: SOURCE_motif2use is a file with the correct motif to use when there are multiple. 
...
# Print the end of catalytic domain (defined as the APE or earlier if APE not present).
...
# Create a table to bind to TCGA genefreqSHORTEST to validate all mutations
...
write.csv (validateTCGA, file = "Validate_TCGA.csv")
